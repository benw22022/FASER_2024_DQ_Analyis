...
def book_per_run_hists(df: ROOT.RDataFrame, run_number: int=None, lumi: float=None) -> List:
    ...
    per_run_histos.append(df_this_run.Histo1D(("VetoNu0_triggertime", "VetoNu0_triggertime;VetoNu0_triggertime;Events", 100, -100, 100), f"VetoNu0_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoNu1_triggertime", "VetoNu1_triggertime;VetoNu1_triggertime;Events", 100, -100, 100), f"VetoNu1_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt10_triggertime", "VetoSt10_triggertime;VetoSt10_triggertime;Events", 100, -200, 200), f"Veto10_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt11_triggertime", "VetoSt11_triggertime;VetoSt11_triggertime;Events", 100, -200, 200), f"Veto11_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt20_triggertime", "VetoSt20_triggertime;VetoSt20_triggertime;Events", 100, -200, 200), f"Veto20_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt21_triggertime", "VetoSt21_triggertime;VetoSt21_triggertime;Events", 100, -200, 200), f"Veto21_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing0_triggertime", "Timing0_triggertime;Timing0_triggertime;Events", 100, -200, 200), f"Timing0_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing1_triggertime", "Timing1_triggertime;Timing1_triggertime;Events", 100, -200, 200), f"Timing1_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing2_triggertime", "Timing2_triggertime;Timing2_triggertime;Events", 100, -200, 200), f"Timing2_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing3_triggertime", "Timing3_triggertime;Timing3_triggertime;Events", 100, -200, 200), f"Timing3_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Preshower0_triggertime", "Preshower0_triggertime;Preshower0_triggertime;Events", 100, -200, 200), f"Preshower0_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Preshower1_triggertime", "Preshower1_triggertime;Preshower1_triggertime;Events", 100, -200, 200), f"Preshower1_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo0_triggertime", "CaloLo0_triggertime;CaloLo0_triggertime;Events", 100, -200, 200), f"CaloLo0_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo1_triggertime", "CaloLo1_triggertime;CaloLo1_triggertime;Events", 100, -200, 200), f"CaloLo1_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo2_triggertime", "CaloLo2_triggertime;CaloLo2_triggertime;Events", 100, -200, 200), f"CaloLo2_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo3_triggertime", "CaloLo3_triggertime;CaloLo3_triggertime;Events", 100, -200, 200), f"CaloLo3_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi0_triggertime", "CaloHi0_triggertime;CaloHi0_triggertime;Events", 100, -200, 200), f"CaloHi0_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi1_triggertime", "CaloHi1_triggertime;CaloHi1_triggertime;Events", 100, -200, 200), f"CaloHi1_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi2_triggertime", "CaloHi2_triggertime;CaloHi2_triggertime;Events", 100, -200, 200), f"CaloHi2_triggertime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi3_triggertime", "CaloHi3_triggertime;CaloHi3_triggertime;Events", 100, -200, 200), f"CaloHi3_triggertime", "weight"))


    per_run_histos.append(df_this_run.Histo1D(("VetoNu0_localtime", "VetoNu0_localtime;VetoNu0_localtime;Events", 100, 100, 350), f"VetoNu0_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoNu1_localtime", "VetoNu1_localtime;VetoNu1_localtime;Events", 100, 100, 350), f"VetoNu1_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt10_localtime", "VetoSt10_localtime;VetoSt10_localtime;Events", 100, 100, 350), f"Veto10_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt11_localtime", "VetoSt11_localtime;VetoSt11_localtime;Events", 100, 100, 350), f"Veto11_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt20_localtime", "VetoSt20_localtime;VetoSt20_localtime;Events", 100, 100, 350), f"Veto20_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt21_localtime", "VetoSt21_localtime;VetoSt21_localtime;Events", 100, 100, 350), f"Veto21_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing0_localtime", "Timing0_localtime;Timing0_localtime;Events", 100, 100, 350), f"Timing0_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing1_localtime", "Timing1_localtime;Timing1_localtime;Events", 100, 100, 350), f"Timing1_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing2_localtime", "Timing2_localtime;Timing2_localtime;Events", 100, 100, 350), f"Timing2_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing3_localtime", "Timing3_localtime;Timing3_localtime;Events", 100, 100, 350), f"Timing3_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Preshower0_localtime", "Preshower0_localtime;Preshower0_localtime;Events", 100, 100, 350), f"Preshower0_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Preshower1_localtime", "Preshower1_localtime;Preshower1_localtime;Events", 100, 100, 350), f"Preshower1_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo0_localtime", "CaloLo0_localtime;CaloLo0_localtime;Events", 100, 100, 350), f"CaloLo0_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo1_localtime", "CaloLo1_localtime;CaloLo1_localtime;Events", 100, 100, 350), f"CaloLo1_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo2_localtime", "CaloLo2_localtime;CaloLo2_localtime;Events", 100, 100, 350), f"CaloLo2_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo3_localtime", "CaloLo3_localtime;CaloLo3_localtime;Events", 100, 100, 350), f"CaloLo3_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi0_localtime", "CaloHi0_localtime;CaloHi0_localtime;Events", 100, 100, 350), f"CaloHi0_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi1_localtime", "CaloHi1_localtime;CaloHi1_localtime;Events", 100, 100, 350), f"CaloHi1_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi2_localtime", "CaloHi2_localtime;CaloHi2_localtime;Events", 100, 100, 350), f"CaloHi2_localtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi3_localtime", "CaloHi3_localtime;CaloHi3_localtime;Events", 100, 100, 350), f"CaloHi3_localtime", "weight"))


    per_run_histos.append(df_this_run.Histo1D(("VetoNu0_bcidtime", "VetoNu0_bcidtime;VetoNu0_bcidtime;Events", 100, 0, 30), f"VetoNu0_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoNu1_bcidtime", "VetoNu1_bcidtime;VetoNu1_bcidtime;Events", 100, 0, 30), f"VetoNu1_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt10_bcidtime", "VetoSt10_bcidtime;VetoSt10_bcidtime;Events", 100, 0, 30), f"Veto10_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt11_bcidtime", "VetoSt11_bcidtime;VetoSt11_bcidtime;Events", 100, 0, 30), f"Veto11_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt20_bcidtime", "VetoSt20_bcidtime;VetoSt20_bcidtime;Events", 100, 0, 30), f"Veto20_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("VetoSt21_bcidtime", "VetoSt21_bcidtime;VetoSt21_bcidtime;Events", 100, 0, 30), f"Veto21_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing0_bcidtime", "Timing0_bcidtime;Timing0_bcidtime;Events", 100, 0, 30), f"Timing0_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing1_bcidtime", "Timing1_bcidtime;Timing1_bcidtime;Events", 100, 0, 30), f"Timing1_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing2_bcidtime", "Timing2_bcidtime;Timing2_bcidtime;Events", 100, 0, 30), f"Timing2_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Timing3_bcidtime", "Timing3_bcidtime;Timing3_bcidtime;Events", 100, 0, 30), f"Timing3_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Preshower0_bcidtime", "Preshower0_bcidtime;Preshower0_bcidtime;Events", 100, 0, 30), f"Preshower0_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("Preshower1_bcidtime", "Preshower1_bcidtime;Preshower1_bcidtime;Events", 100, 0, 30), f"Preshower1_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo0_bcidtime", "CaloLo0_bcidtime;CaloLo0_bcidtime;Events", 100, 0, 30), f"CaloLo0_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo1_bcidtime", "CaloLo1_bcidtime;CaloLo1_bcidtime;Events", 100, 0, 30), f"CaloLo1_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo2_bcidtime", "CaloLo2_bcidtime;CaloLo2_bcidtime;Events", 100, 0, 30), f"CaloLo2_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloLo3_bcidtime", "CaloLo3_bcidtime;CaloLo3_bcidtime;Events", 100, 0, 30), f"CaloLo3_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi0_bcidtime", "CaloHi0_bcidtime;CaloHi0_bcidtime;Events", 100, 0, 30), f"CaloHi0_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi1_bcidtime", "CaloHi1_bcidtime;CaloHi1_bcidtime;Events", 100, 0, 30), f"CaloHi1_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi2_bcidtime", "CaloHi2_bcidtime;CaloHi2_bcidtime;Events", 100, 0, 30), f"CaloHi2_bcidtime", "weight"))
    per_run_histos.append(df_this_run.Histo1D(("CaloHi3_bcidtime", "CaloHi3_bcidtime;CaloHi3_bcidtime;Events", 100, 0, 30), f"CaloHi3_bcidtime", "weight"))
